...
\caption{Multi-dimensional framework comparison across six production-readiness criteria (scores 0--10). Latency is inverted: a higher score means lower latency. Scores reflect the analysis in \S3.2--3.6.}
